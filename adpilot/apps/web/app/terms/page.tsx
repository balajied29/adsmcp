...
export const metadata = { title: "Terms of Service — AdPilot" };
  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-7 text-zinc-700">
        <p>
          By using AdPilot you authorize it to access and, only with your explicit
        ...
        <section>
          ...
          <p>
            ...
            advertising policies. AdPilot proposes changes; approved actions are
