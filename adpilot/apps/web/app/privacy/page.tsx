...
export const metadata = { title: "Privacy Policy — AdPilot" };
  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-7 text-zinc-700">
        <p>
          AdPilot connects to your Meta ad accounts, with your permission, to analyze
        ...
        <section>
          ...
          <p>
            ...
            Deleting your AdPilot account removes all associated data. You can also
